...
- (void)recordMp4Stop;
- (int)audioMute:(BOOL)enable;

@property(nonatomic, readonly)  UIView *view;
@property(nonatomic)            NSTimeInterval currentPlaybackTime;
@property(nonatomic)            NSTimeInterval currentPlaybackTime_mym3u8;
...
IJK_EXTERN NSString *const IJKMPMoviePlayerSnapShotNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerSnapShotTargetKey;
IJK_EXTERN NSString *const IJKMPMoviePlayerSnapShotTargetPath;

IJK_EXTERN NSString *const IJKMPMoviePlayerRecordMp4Notification;
IJK_EXTERN NSString *const IJKMPMoviePlayerRecordMp4TargetKey;
IJK_EXTERN NSString *const IJKMPMoviePlayerRecordMp4TargetPath;
@end
