...
#pragma mark - Tool
/**
 Signature file, get temporary access url on rubetek cloud service(签名文件,获取在rubetek云服务上的临时访问url)
 @param urlList 待签名的url列表
*/
- (void)rubetekSignatureFileWith:(NSArray *)urlList success:(MeariSuccess_Dictionary)success failure:(MeariFailure)failure;
#pragma mark - Cancel
/**
Clean user info
清除用户信息
