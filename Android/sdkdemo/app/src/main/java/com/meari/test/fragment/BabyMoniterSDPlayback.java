 ...
 */
public class BabyMoniterSDPlayback extends VideoFragment implements CalendarDialog.CalendarDayInterface, AlarmRecyclerAdapter.VideoEventImplement {
    private String TAG = "BabyMoniterSDPlayback";
    ...
    public static BabyMoniterSDPlayback newInstance(String time, CameraInfo cameraInfo, VideoPlayCallback videoPlayCallback) {
        BabyMoniterSDPlayback fragment = new BabyMoniterSDPlayback();
...
//            calendarDialog.getWindow().setLayout(screenWidth-75,(int) ((screenHight * 2 / 5) + 80));
    ...
    public void onResumePauseVideo() {
        if (mVideoPlayCallback.getCameraPlayer() != null && (mVideoPlayCallback.getCameraPlayer().mstatus & mVideoPlayCallback.getCameraPlayer().Playbacking) == mVideoPlayCallback.getCameraPlayer().Playbacking) {
