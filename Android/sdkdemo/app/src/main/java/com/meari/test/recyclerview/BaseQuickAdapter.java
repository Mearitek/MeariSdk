 ...
 */
package com.meari.test.recyclerview;
...
import com.meari.test.recyclerview.animation.AlphaInAnimation;
import com.meari.test.recyclerview.animation.BaseAnimation;
import com.meari.test.recyclerview.animation.ScaleInAnimation;
import com.meari.test.recyclerview.animation.SlideInBottomAnimation;
import com.meari.test.recyclerview.animation.SlideInLeftAnimation;
import com.meari.test.recyclerview.animation.SlideInRightAnimation;
import com.meari.test.recyclerview.entity.IExpandable;
import com.meari.test.recyclerview.loadmore.LoadMoreView;
import com.meari.test.recyclerview.loadmore.SimpleLoadMoreView;
import com.meari.test.recyclerview.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    /**
     * check if full page after {@link #setNewData(ArrayList)}, if full, it will enable load more again.
     *
     * @param recyclerView your recyclerView
     * @see #setNewData(ArrayList)
     */
     ...
     */
    public BaseQuickAdapter(int layoutResId, ArrayList<T> data) {
     ...
     * @param data
     */
    public void setNewData(ArrayList<T> data) {
        if (mData == null) {
            mData = new ArrayList<>();
        }
        mData.clear();
