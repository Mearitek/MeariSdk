...
import com.meari.test.wheelview.ScreenInfo;
import com.meari.test.wheelview.WheelTimeOptions;
...
public class TimeSetPop extends PopupWindow implements View.OnClickListener {
    private View rootView; // 总的布局
    WheelTimeOptions wheelOptions;
    private View btnSubmit, btnCancel;
    private OnOptionsSelectListener optionsSelectListener;
    private static final String TAG_SUBMIT = "submit";
    private static final String TAG_CANCEL = "cancel";

    public TimeSetPop(Context context) {
        super(context);
        ...
        rootView = mLayoutInflater.inflate(R.layout.pop_time_options, null);
        // -----确定和取消按钮
