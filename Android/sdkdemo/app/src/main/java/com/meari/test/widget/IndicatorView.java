 ...
 *
 * @author pupu
 * @time 2017年8月2日19:38:46
 * 修改了动画预设，控件UI表现，点击事件逻辑判断
 */
...
//        mPaint.setColor(mLineColor);
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.btn_green_light));
    ...
    private void drawDots(Canvas canvas) {
        mDotColor = ContextCompat.getColor(getContext(), R.color.btn_green_light);
...
//                int cx = i * mLineLength  + mIndicatorSize / 2;
                int cy = getHeight() / 2;
...
//                } else
                ...
                if (i > index) {
                    ...
                    Paint paint = new Paint();
                    paint.setColor(0xffCCC8C3);
                    canvas.drawCircle(cx, cy, mDotSize / 2, paint);
                } else {
                    canvas.drawCircle(cx, cy, mDotSize / 2, mPaint);
                }
