...
public class NvrShareViewHolder extends BaseViewHolder {
    ...
    public NvrShareViewHolder(View view) {
        super(view);
        ...
        this.headIcon.getHierarchy().setPlaceholderImage(R.mipmap.personalhead, ScalingUtils.ScaleType.FIT_XY);
    }
}
