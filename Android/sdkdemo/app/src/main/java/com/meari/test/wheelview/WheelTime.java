...
import com.meari.test.pop.TimePopupWindow.Type;
...
//        wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字
        ...
        OnWheelChangedListener wheelListener_hour = new OnWheelChangedListener() {
            ...
            public void onChanged(WheelView wheel, int oldValue, int newValue) {
                if (newValue == 24) {
                    wv_mins.setAdapter(new NumericWheelAdapter(0, 0,"%02d"));
...
//        wv_mins.setCyclic(true);
        ...
        wv_hours.setPaddingLeft(Constant.width/4);
        wv_mins.setPaddingRight(Constant.width/4);
    }
