 ...
 */
public class SingleVideoPlaybackNVRFragment extends VideoFragment implements CalendarDialog.CalendarDayInterface, AlarmRecyclerAdapter.VideoEventImplement {
    ...
    public static SingleVideoPlaybackNVRFragment newInstance(String time, CameraInfo cameraInfo, VideoPlayCallback videoPlayCallback) {
        SingleVideoPlaybackNVRFragment fragment = new SingleVideoPlaybackNVRFragment();
...
//        mCameraInfo.setDeviceName(info.getDeviceName());
//        mCameraInfo.setSnNum(info.getSnNum());
//        mCameraInfo.setUserAccount(info.getUserAccount());
//        mCameraInfo.setDeviceP2P(info.getDeviceP2P());
//        mCameraInfo.setTp(info.getTp());
//        mCameraInfo.setDeviceUUID(info.getNvrUUID());
//        mCameraInfo.setDeviceType(info.getDeviceType());
//        mCameraInfo.setNvrUUID(info.getNvrUUID());
//        mCameraInfo.setNvrPort(info.getNvrPort());
//        mCameraInfo.setBindingTy(info.getBindingTy());
//        mCameraInfo.setNvrKey(info.getNvrKey());
//        mCameraInfo.setHostKey(info.getHostKey());
    }
...
//            mCurplayer.stopRecordPlay();
    ...
    private void setEnabledVoice(boolean enable) {
        ...
        if (!enable) {
            ...
            this.mVoiceImg_L.setImageResource(R.drawable.btn_voice_disenale);
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case HANDLER_MSG_EVENT_SCALE:
                    ...
                    if (!mPullScaleView)
                        mScaleView.setTimeProgrogress(mHour, mMinute, mSecond);
                    Log.e("mScaleView", String.format("%04d-%02d-%02d %02d:%02d:%02d", mYear, mMonth, mDay, mHour, mMinute, mSecond));
                    mLoadingView.setVisibility(View.GONE);
                    break;
...
//            calendarDialog.getWindow().setLayout(screenWidth-75,(int) ((screenHight * 2 / 5) + 80));
