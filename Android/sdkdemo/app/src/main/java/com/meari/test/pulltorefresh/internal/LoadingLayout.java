 ...
 *******************************************************************************/
package com.meari.test.pulltorefresh.internal;
...
import com.meari.test.pulltorefresh.ILoadingLayout;
import com.meari.test.pulltorefresh.PullToRefreshBase.Mode;
import com.meari.test.pulltorefresh.PullToRefreshBase.Orientation;
...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
	...
	public LoadingLayout(Context context, final Mode mode, final Orientation scrollDirection, TypedArray attrs) {
		...
		AnimationDrawable animationDrawable = (AnimationDrawable) mHeaderProgress.getDrawable();
